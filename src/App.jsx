...
return(
<main className="min-h-shv bg-offwhitebg py-20 px-6">
  <section>
    <div className="bg-orange p-12 rounded-t-lg">
  <img src={iconSedans} alt="Icones do carros sedan" className="mb-7" />
...
<img src={iconSuvs} alt="Icones do carros SUVs" className="mb-7" />
...
<a className="font-lexend" href="https://www.webmotors.com.br/suvs" target="_blank">Ver mais</a>
    ...
    <div className="bg-dark-green p-12 rounded-b-lg">
      <img src={iconLuxury} alt="Icones do carros luxo" className="mb-7"/>
